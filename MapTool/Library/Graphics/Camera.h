...
public:
	...
	void SetCameraMode(CameraMode camMode) {m_camMode = camMode;}
	...
	float GetOrthgraphicHeight()const;
	float GetOrthgraphicWidth()const;
...
private:
	...
	DirectX::XMFLOAT4X4 mView = DirectX::SimpleMath::Matrix();
	DirectX::XMFLOAT4X4 mProj = DirectX::SimpleMath::Matrix();
	DirectX::XMFLOAT4X4 mProj_orthographic = DirectX::SimpleMath::Matrix();
